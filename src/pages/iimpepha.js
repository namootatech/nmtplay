  ...
  return (
    <section class='mt-24 min-h-screen py-8 transition-all ease-in-out min-h-max bg-gray-800 dark:bg-gray-950 flex justify-center'>
      <div className='container max-w-4xl text-white p-8'>
        ...
        <p className='py-8'>
          Moja ke mgutyuli!, kule page you will find iidownloads zee documents
          and forms zika government, school or business.
        </p>
        ...
        <div className='hidden md:flex'>
          <Table
            ...
            data={documents.map((doc) => ({
              ...
              actions: (
                <button
                  className='bg-fuchsia-700 text-white p-1 text-xs flex gap-2 rounded-md text-center'
