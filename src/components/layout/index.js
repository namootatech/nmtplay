  ...
  return (
    <>
      <Head>
        ...
        <script
          src='//pertawee.net/ntfc.php?p=8927759'
          data-cfasync='false'
          async
          onerror='_wrczv()'
          onload='_tfhtjfet()'
