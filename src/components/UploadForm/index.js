...
const Categories = [
  ...
  },
  {
    ...
    subs: [
      ...
      { id: 'youtube-show', title: 'Youtube Show' },
      { id: 'stories', title: 'Stories' },
      { id: 'amapiano', title: 'Amapiano' },
      { id: 'house', title: 'House' },
      { id: 'gqom', title: 'Gqom' },
      { id: 'sjokojoko', title: 'Sjokojoko' },
      { id: 'deep-house', title: 'Deep House' },
      { id: 'afro-house', title: 'Afro House' },
      { id: 'hip-hop', title: 'Hip Hop' },
      { id: 'mzansi-hip-hop', title: 'Mzansi Hip Hop' },
      { id: 'afro-pop', title: 'Afro Pop' },
      { id: 'rnb', title: 'R&B' },
      { id: 'maskandi', title: 'Maskandi' },
      { id: 'international-gospel', title: 'International Gospel' },
      { id: 'gospel', title: 'Gospel' },
      { id: 'choral', title: 'Choral' },
      { id: 'jazz', title: 'Jazz' },
      { id: 'classic', title: 'Classic' },
      { id: 'other-music', title: 'Other Music' },
      { id: 'other-mp3', title: 'Other Mp3' },
    ],
  },
  {
    id: 'videos',
